          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-4 sm:gap-6">
            {gradesForShift.map((grade) => (
              <button
                ...
                className="bg-[#3b5998] text-white aspect-square flex items-center justify-center rounded-2xl font-black text-xl sm:text-2xl shadow-md hover:bg-blue-700 hover:scale-105 active:scale-90 transition-all border-b-4 border-blue-900"
              >
                {grade.replace('º ', '')}
              </button>
            ))}
