        ...
        <div className="mb-10 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-5 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:bg-white focus:border-[#3b5998] outline-none font-bold text-gray-700 transition-all"
              value={studentSearch}
              ...
              <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-40">
                {filteredStudents.map(s => (
                  ...
                  >
                    ...
                    {selectedIds.includes(s.id) && <CheckCircle2 size={18} className="ml-auto text-green-500" />}
                  </button>
                ))}
              </div>
            )}
